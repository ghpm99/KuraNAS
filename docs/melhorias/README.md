...
| 19 | [Captura inteligente de streaming](19-captura-inteligente-de-streaming.md) | feature | P3 | — | pendente | Fase 2 da ingestão; Fase 1 (`ingest` + `/ingest/fetch` via yt-dlp) já em `develop`. Captura de saída (analog hole) com máquina de estados por episódio; **sem decrypt de DRM** |
