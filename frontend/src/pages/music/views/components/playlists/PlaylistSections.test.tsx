...
const createTrackFile = (
    overrides: Omit<Partial<IMusicData>, 'metadata'> & {
        metadata?: Partial<NonNullable<IMusicData['metadata']>>;
    } = {}
): IMusicData => {
    const metadata = {
        id: 1,
...
const createPlaylistTrack = (
    overrides: Partial<PlaylistTrack> & { file?: IMusicData } = {}
): PlaylistTrack => ({
    id: 10,
    position: 1,
