...
export const navigationItems: NavigationItem[] = [
	...
	{ href: appRoutes.favorites, icon: <Star size={20} />, labelKey: 'STARRED_FILES' },
	{ href: appRoutes.images, icon: <BookImage size={20} />, labelKey: 'NAV_IMAGES' },
	{ href: appRoutes.music, icon: <Music size={20} />, labelKey: 'NAV_MUSIC' },
	{ href: appRoutes.videos, icon: <Videotape size={20} />, labelKey: 'NAV_VIDEOS' },
	{ href: appRoutes.analytics, icon: analyticsIcon, labelKey: 'ANALYTICS' },
	{ href: appRoutes.settings, icon: <Settings size={20} />, labelKey: 'SETTINGS' },
