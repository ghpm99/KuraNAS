					...
					return (
						<div className={styles.allVideoItem} key={video.id}>
							...
							<div className={styles.allVideoActions}>
								<button type='button' className={styles.actionBtn} onClick={() => onPlayVideo(video.id, null)}>
									<Play size={14} />
									{t('VIDEO_PLAY')}
								</button>
								<select
									...
									onChange={(event) => onSelectPlaylistForVideo(video.id, Number(event.target.value))}
								>
