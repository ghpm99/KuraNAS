...
interface AnalyticsData {
  ...
  users: {
    usage: UserUsage[]
    topContributor: { name: string; files: number }
  }
  organization: {
    emptyFolders: number
    emptyPaths: string[]
...
export function AnalyticsProvider({ children }: { children: ReactNode }) {
  const [analyticsData] = useState<AnalyticsData>({
    ...
    users: {
      usage: [
        { user: "João Silva", files: 15234, space: "456 GB" },
        { user: "Maria Santos", files: 12890, space: "378 GB" },
        { user: "Pedro Costa", files: 8765, space: "234 GB" },
        { user: "Ana Oliveira", files: 6543, space: "189 GB" },
        { user: "Carlos Lima", files: 2246, space: "67 GB" },
      ],
      topContributor: { name: "João Silva", files: 15234 },
    },
    organization: {
      emptyFolders: 47,
      emptyPaths: [
