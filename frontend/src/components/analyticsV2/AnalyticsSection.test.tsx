...
describe('components/analyticsV2', () => {
	...
	it('renders KPI card with and without help text', () => {
		const { rerender } = render(<AnalyticsKpiCard title='Storage' value='50 GB' helpText='25 GB free' />);
	...
	it('switches between loading, error, empty and content states', () => {
		...
		rerender(
			<AnalyticsSection title='Section' loading={false} empty emptyKey='ANALYTICS_NOTHING_HERE'>
				<div>Loaded content</div>
			</AnalyticsSection>,
		);
