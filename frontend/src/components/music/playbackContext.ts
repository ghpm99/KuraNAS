...
export const createPlaylistPlaybackContext = (playlist: Pick<Playlist, 'id' | 'name'>): MusicPlaybackContext => ({
	kind: 'playlist',
...
export const createRouteMusicPlaybackContext = (pathname: string, search = ''): MusicPlaybackContext => {
