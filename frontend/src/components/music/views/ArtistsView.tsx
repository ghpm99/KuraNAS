...
export default function ArtistsView() {
	...
	const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } = useInfiniteQuery({
		...
		queryFn: async ({ pageParam = 1 }): Promise<Pagination<MusicArtist>> => getMusicArtists(pageParam, MUSIC_COLLECTION_PAGE_SIZE),
		initialPageParam: 1,
...
function ArtistListView({ artists, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage, onSelect }: ArtistListViewProps) {
	const { t } = useI18n();
					...
					<Grid key={artist.artist} size={{ xs: 6, sm: 4, md: 3, lg: 2.4 }}>
						...
						>
							<CardActionArea
								...
								onKeyDown={(event) => handleKeyboardActivation(event, () => onSelect(artist))}
