...
export default function AlbumsView() {
	...
	const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } = useInfiniteQuery({
		...
		queryFn: async ({ pageParam = 1 }): Promise<Pagination<MusicAlbum>> => getMusicAlbums(pageParam, MUSIC_COLLECTION_PAGE_SIZE),
		initialPageParam: 1,
...
function AlbumListView({ albums, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage, onSelect }: AlbumListViewProps) {
	const { t } = useI18n();
