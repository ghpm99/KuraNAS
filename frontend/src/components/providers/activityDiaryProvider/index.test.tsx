        ...
        t: (key: string) =>
            (
                ({
                    ...
                    ACTIVITY_NAME_INVALID_ERROR:
                        'O nome da atividade só pode conter letras e números.',
        ...
        <div>
            <form onSubmit={context.handleSubmit} aria-label="diary-form">
                <input
                    ...
                    onChange={(e) => context.handleNameChange(e as any)}
                />
                <textarea
            ...
            <div data-testid="duration">
                {context.getCurrentDuration('2026-01-01T00:00:00.000Z')}
            </div>
        </div>
    );
};
...
describe('providers/activityDiaryProvider/index', () => {
    ...
    it('validates form and submits normalized payload', () => {
        ...
        expect(mockEnqueueSnackbar).toHaveBeenCalledWith('Atividade adicionada com sucesso!', {
            variant: 'success',
        });
    ...
    it('copies activity and handles mutation errors', () => {
        ...
        expect(mockEnqueueSnackbar).toHaveBeenCalledWith('Erro ao adicionar atividade.', {
            variant: 'error',
        });
        expect(mockEnqueueSnackbar).toHaveBeenCalledWith('Erro ao duplicar atividade.', {
            variant: 'error',
        });
    });
