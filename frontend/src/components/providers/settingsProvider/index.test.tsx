...
describe('components/providers/settingsProvider', () => {
	...
	it('loads settings and applies appearance runtime values', async () => {
		...
		expect(document.documentElement.style.getPropertyValue('--app-color-primary-hover')).toBe('#22D3EE');
	...
	it('applies violet accent palette CSS variables', async () => {
		...
		expect(document.documentElement.style.getPropertyValue('--app-color-primary')).toBe('#6D5DF6');
		expect(document.documentElement.style.getPropertyValue('--app-color-primary-hover')).toBe('#7C70FF');
	});
	...
	it('applies rose accent palette CSS variables', async () => {
		...
		expect(document.documentElement.style.getPropertyValue('--app-color-primary')).toBe('#E11D48');
		expect(document.documentElement.style.getPropertyValue('--app-color-primary-hover')).toBe('#FB7185');
	});
