export const visualTokens = {
	...
	backgrounds: {
		app:
			'radial-gradient(1200px 400px at 20% -10%, rgba(225, 29, 72, 0.18), transparent 60%), radial-gradient(900px 320px at 95% 2%, rgba(14, 116, 144, 0.22), transparent 62%), linear-gradient(180deg, #070a10 0%, #0a1018 100%)',
		panel:
			'linear-gradient(180deg, rgba(18, 26, 41, 0.94) 0%, rgba(15, 22, 35, 0.98) 100%)',
		panelElevated:
