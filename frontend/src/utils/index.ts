...
export const getFileTypeInfo = (format: string): formatType => {
    const fileTypes: Record<string, formatType> = {
        ...
        '.mov': {
            ...
            description: 'VIDEO_MOV',
        },

        '.pdf': {
            type: 'document',
            mime: 'application/pdf',
            description: 'DOCUMENT_PDF',
        },
        '.txt': {
            type: 'document',
            mime: 'text/plain',
            description: 'DOCUMENT_TXT',
        },
        '.html': {
            type: 'document',
            mime: 'text/html',
            description: 'DOCUMENT_HTML',
        },
        '.htm': {
            type: 'document',
            mime: 'text/html',
        ...
        '.xml': {
            ...
            description: 'DOCUMENT_XML',
        },
        '.json': {
            type: 'document',
            mime: 'application/json',
            description: 'DOCUMENT_JSON',
        },
        ...
        '.zip': {
            ...
            description: 'ARCHIVE_ZIP',
        },
        '.rar': {
            type: 'archive',
            mime: 'application/vnd.rar',
            description: 'ARCHIVE_RAR',
        },
        '.7z': {
            type: 'archive',
            mime: 'application/x-7z-compressed',
            description: 'ARCHIVE_7Z',
        },
        '.tar': {
            type: 'archive',
            mime: 'application/x-tar',
            description: 'ARCHIVE_TAR',
        },
        '.gz': {
            type: 'archive',
            mime: 'application/gzip',
            description: 'ARCHIVE_GZIP',
        },
    };

    return (
        fileTypes[format.toLowerCase()] || {
            type: 'unknown',
            mime: '',
