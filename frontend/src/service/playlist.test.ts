...
describe('service/playlist', () => {
    ...
    it('creates and updates a playlist', async () => {
        ...
        expect(mockedApi.post).toHaveBeenCalledWith('/music/playlists/', {
            name: 'Nova',
        });
        expect(mockedApi.put).toHaveBeenCalledWith('/music/playlists/1', {
            name: 'Atualizada',
        });
    ...
    it('adds and removes track from playlist', async () => {
        ...
        expect(mockedApi.post).toHaveBeenCalledWith('/music/playlists/2/tracks', {
            file_id: 10,
        });
